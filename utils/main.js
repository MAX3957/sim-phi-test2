...
(function() {
	...
	const w = `作者：<a style="text-decoration:underline"target="_blank"href="//space.bilibili.com/274753872">${d}</a><br>`;
	...
	function cnymd(time) {
		...
		return `${d.getFullYear()}年${d.getMonth() + 2}月${d.getDate() - 1}日`;
	}
})();
